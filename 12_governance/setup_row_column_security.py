...
# MAGIC CREATE OR REPLACE FUNCTION financial_lakehouse.gold.row_filter_by_business_unit(business_unit STRING)
...
# MAGIC CREATE OR REPLACE FUNCTION financial_lakehouse.gold.row_filter_by_account(account_id STRING)
# MAGIC RETURNS BOOLEAN
# MAGIC RETURN
# MAGIC   CASE
...
# MAGIC       SELECT account_id FROM financial_lakehouse.gold.user_account_mapping 
...
# MAGIC CREATE OR REPLACE FUNCTION financial_lakehouse.gold.mask_account_holder(account_holder STRING)
...
# MAGIC CREATE OR REPLACE FUNCTION financial_lakehouse.gold.mask_ssn(ssn STRING)
# MAGIC RETURNS STRING
# MAGIC RETURN
# MAGIC   CASE
...
# MAGIC CREATE OR REPLACE FUNCTION financial_lakehouse.gold.mask_email(email STRING)
# MAGIC RETURNS STRING
# MAGIC RETURN
# MAGIC   CASE
...
# MAGIC CREATE OR REPLACE FUNCTION financial_lakehouse.gold.mask_dollar_amount(amount DECIMAL(18,2))
# MAGIC RETURNS STRING
# MAGIC RETURN
# MAGIC   CASE
...
# MAGIC SET ROW FILTER financial_lakehouse.gold.row_filter_by_account ON (acct_id);
# MAGIC
# MAGIC -- Apply row filter to trading summary
# MAGIC ALTER TABLE financial_lakehouse.gold.daily_trading_summary
# MAGIC SET ROW FILTER financial_lakehouse.gold.row_filter_by_business_unit ON (business_unit);
...
# MAGIC
# MAGIC -- ALTER TABLE financial_lakehouse.gold.customer_accounts
# MAGIC -- ALTER COLUMN account_holder_name SET MASK financial_lakehouse.gold.mask_account_holder;
# MAGIC --
# MAGIC -- ALTER TABLE financial_lakehouse.gold.customer_accounts  
# MAGIC -- ALTER COLUMN ssn SET MASK financial_lakehouse.gold.mask_ssn;
# MAGIC --
# MAGIC -- ALTER TABLE financial_lakehouse.gold.customer_accounts
# MAGIC -- ALTER COLUMN email SET MASK financial_lakehouse.gold.mask_email;
...
# MAGIC -- ALTER TABLE financial_lakehouse.gold.account_performance DROP ROW FILTER;
# MAGIC
# MAGIC -- Remove column mask
# MAGIC -- ALTER TABLE financial_lakehouse.gold.customer_accounts ALTER COLUMN ssn DROP MASK;
